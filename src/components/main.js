...
constructor(){ 
   ...
   filterTable(e){ 
    ...
    render(){ 
      return( 
        <div>         <div className="search-form">         <div> 
         <h3>Enter the search text</h3> 
       </div> 
      <form onSubmit={this.filterTable}> 
        <div className="form-group">        <input type="text" value={this.state.searchTxt} onChange={this.setSearchTxt} />           <button  type="submit">Search</button>          <span className="star" onClick={this.starClick}>*</span>          </div> 
        </form> 
       </div> 
